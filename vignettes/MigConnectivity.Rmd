...
for (sim in 1:nSims16) {
  ...
  for (i in nScenarios16) {
    ...
    compare16.array2[sim, 'MCA'] <- calcMC(breedDist16[[i]], nonbreedDist16[[i]], 
                                             results16[[i]]$psi, 
                                             originAbund = breedingN16[[i]])
    compare16.array2[sim, 'MCss1'] <- calcMC(breedDist16[[i]], nonbreedDist16[[i]], 
                                             results16[[i]]$psi, 
                                             originAbund = table(animalLoc16[[i]][ , 1, 1, 1]))
    compare16.array2[sim, 'MCss2'] <- calcMC(breedDist16[[i]], nonbreedDist16[[i]], 
                                             results16[[i]]$psi, 
