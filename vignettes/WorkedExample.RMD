...
relAbundYEWAWint$ID <- targetSitesProj$region
relAbundYEWAWint$rel <- relAbundYEWAWint$nonbreeding/sum(relAbundYEWAWint$nonbreeding)

relAbundYEWABreed <- terra::extract(b, originSitesProj, fun = 'sum', na.rm = T)
relAbundYEWABreed$ID <- originSitesProj$region
relAbundYEWABreed$rel <- relAbundYEWABreed$breeding/sum(relAbundYEWABreed$breeding)
