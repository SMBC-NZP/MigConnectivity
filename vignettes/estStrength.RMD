...
Simple, made up example with four breeding and four nonbreeding regions
...
and pull out previously estimated transition probabilities (using the package RMark)
```{r}
...
previously estimated relative abundances (BBS style analysis)
```{r}
