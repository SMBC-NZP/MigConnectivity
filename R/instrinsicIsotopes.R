...
#'  \describe{
#'   \item{\code{probassign}}{raster stack of individual probabilistic
#'   assignments}
#'   \item{\code{oddsassign}}{raster stack that includes likely vs unlikely
#'   origin for each animal}
#'   \item{\code{popassign}}{a raster for population level assignment (sum of
#'   \code{oodsassign} if \code{population} = NULL). If \code{population} is a
#'   vector then returns a raster stack for each unique \code{population}
#'   provided}
